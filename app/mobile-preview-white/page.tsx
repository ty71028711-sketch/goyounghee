            ...
            <div className="relative">
              ...
              <div className="w-56 rounded-[2.5rem] p-2 shadow-2xl"
                ...
                <div className="flex justify-center mb-1">
                  <div className="rounded-b-2xl flex items-center justify-center gap-1.5"
                    style={{ width: '5rem', height: '1.25rem', backgroundColor: '#9ca3af' }}>
                    <div className="rounded-full" style={{ width: '0.375rem', height: '0.375rem', backgroundColor: '#6b7280' }} />
